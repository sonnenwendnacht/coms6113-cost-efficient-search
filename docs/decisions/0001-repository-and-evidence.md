...
- Initially use a private repository under `sonnenwendnacht`, named `coms6113-cost-efficient-search`, with `main` as the shared branch. **Visibility superseded by [0002](0002-public-repository.md)** at the owner's explicit request.
